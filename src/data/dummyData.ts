import type { Taak, Contact, User } from '../types'
...
export const DEMO_USERS: User[] = [
  ...
  {
    id: 'u3',
    naam: 'Lars Hendriksen',
    email: 'l.hendriksen@reservist.nl',
    pin: '2222',
    rol: 'reservist',
    pelotoon: '1e Peloton',
    ...
    taken: [
      ...
      { taskId: 't3', voltooid: false },
      { taskId: 't4', voltooid: false },
      { taskId: 't5', voltooid: false },
      { taskId: 't6', voltooid: true, voltooiDatum: '2024-03-03' },
    ],
  },
  {
    id: 'u4',
    naam: 'Sophie van Dam',
    email: 's.vandam@reservist.nl',
    pin: '3333',
    rol: 'reservist',
    pelotoon: '1e Peloton',
    ...
    taken: [
      ...
      { taskId: 't3', voltooid: false },
      { taskId: 't4', voltooid: true, voltooiDatum: '2024-03-10' },
      { taskId: 't5', voltooid: false },
      { taskId: 't6', voltooid: false },
    ],
  },
  {
    id: 'u5',
    naam: 'Kevin Meijer',
    email: 'k.meijer@reservist.nl',
    pin: '4444',
    rol: 'reservist',
    pelotoon: '2e Peloton',
